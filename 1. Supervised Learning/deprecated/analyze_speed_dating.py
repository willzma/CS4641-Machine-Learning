...
with open("datasets/Speed_Dating_Experiment.csv", "r", encoding="utf8") as file:
...
for record in csv_list:
    input_vector = []
    if record[13] == "" or record[15] == "" or record[16] == "":
        count += 1
        continue
    ...
    input_vector.append(int(record[16]))
    ...
    output_vector = int(float(record[13]) * 10)
